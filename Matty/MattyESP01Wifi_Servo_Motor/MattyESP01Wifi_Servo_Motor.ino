...
int M1backward = 4;  // MotorDirectionPin set to pin4
int M1forward = 5;   // MotorDirectionPin set to pin5
int M2forward = 6;   // MotorDirectionPin set to pin6
int M2backward = 9;  // MotorDirectionPin set to pin9
