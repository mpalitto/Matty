...
Plan changed, I am going to use INMP441 and a 8266 board for interfacing...
...
1st step is to verify that the sampled data is valid... to do that I can try to play the captured sound back to a speaker...
  to do this I can use the 8266 Audio library that is able to play sounds stored in a few formats and from an array of unsigned char....
  I m not clear how can it know what is the sample rates... we will see...
  Right now I am not sure how much is the sampling rate right now.... since I am just reading out of the mic whenever.... 
  a lot of confusion right now... it is going to take a little while before I figure it out
